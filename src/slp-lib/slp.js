...
class Slp {
    ...
    buildInitTx(ticker, name, urlOrEmail, decimals, initialQuantity, addressQuantities) {
        ...
        this.sendInitTx(this.initOpReturn, addressQuantities)
    }

    async sendInitTx(initOpReturn, genesisTokenAddress) {
